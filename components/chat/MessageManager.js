...
import ServiceMessage from "../../components/chat/ServiceMesseage";
import UserMessage from "../../components/chat/UserMesseage";
...
export default class MessageManager extends Component {
  ...
  componentDidMount() {
    ...
    const { type, texts, delays } = this.props;
